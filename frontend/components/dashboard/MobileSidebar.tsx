...
export function MobileSidebar({ isOpen, onClose, userName }: MobileSidebarProps) {
        ...
        <>
            ...
            <aside style={{
                        ...
                        return (
                            <Link 
                                ...
                                style={{
                                    ...
                                    padding: '12px 14px', border: 'none', borderRadius: 8, cursor: 'pointer',
                                    textAlign: 'left', marginBottom: 4, transition: 'all 0.15s', textDecoration: 'none',
                ...
                <div style={{ padding: '14px 16px', borderTop: `1px solid ${T.border}` }}>
                    <button onClick={() => setEmergencyModal(true)} style={{
                        width: '100%', padding: 10, background: T.redLight,
                        border: `1px solid ${T.redBorder}`, borderRadius: 8,
                        color: T.redText, fontSize: 13, fontWeight: 700, cursor: 'pointer', letterSpacing: '0.3px',
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        <div style={{
                            width: 36, height: 36, borderRadius: '50%', background: 'rgba(56,189,248,0.2)',
                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                            fontSize: 14, fontWeight: 700, color: T.blue,
                        }}>{userInitial}</div>
                        <div style={{ flex: 1, overflow: 'hidden' }}>
                            <div style={{ fontSize: 13, fontWeight: 600, color: '#fff', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{userEmail}</div>
            ...
            {emergencyModal && (
                <div style={{
                    ...
                    <div style={{
                        background: '#fff', borderRadius: 16, padding: 24, maxWidth: 340, width: '90%',
                        boxShadow: '0 20px 60px rgba(0,0,0,0.3)',
                    }}>
                        <div style={{ fontSize: 36, textAlign: 'center', marginBottom: 12 }}>⏹</div>
                        <h2 style={{ margin: '0 0 8px', textAlign: 'center', color: '#DC2626', fontSize: 18, fontWeight: 800 }}>
                            Emergency Stop All?
                        </h2>
                        <p style={{ textAlign: 'center', color: '#475569', fontSize: 13, margin: '0 0 20px', lineHeight: 1.5 }}>
                            This will <strong>immediately exit all positions</strong> and stop all strategies. This cannot be undone.
                        </p>
